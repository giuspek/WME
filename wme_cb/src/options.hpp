...
OPTION( binary,            0,  0,  1,0,0,1, "use binary proof format") \
...
OPTION( checkproof,        0,  0,  3,0,0,0, "1=drat, 2=lrat, 3=both") \
OPTION( checkwitness,      1,  0,  1,0,0,0, "check witness internally") \
OPTION( chrono,            1,  0,  2,0,0,1, "chronological backtracking") \
OPTION( chronoalways,      1,  0,  1,0,0,1, "force always chronological") \
OPTION( chronolevelim,   1e2,  0,2e9,0,0,1, "chronological level limit") \
OPTION( chronoreusetrail,  0,  0,  1,0,0,1, "reuse trail chronologically") \
...
OPTION( elimites,          0,  0,  1,0,0,1, "find if-then-else gates") \
...
OPTION( elimsum,           0,  0,1e4,0,0,1, "elimination score sum weight") \
...
OPTION( rephase,           0,  0,  1,0,0,1, "enable resetting phase") \
...
OPTION( shufflequeue,      0,  0,  1,0,0,1, "shuffle variable queue") \
OPTION( shufflerandom,     0,  0,  1,0,0,1, "not reverse but random") \
OPTION( shufflescores,     0,  0,  1,0,0,1, "shuffle variable scores") \
...
OPTION( subsume,           0,  0,  1,0,1,1, "enable clause subsumption") \
