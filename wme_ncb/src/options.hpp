...
OPTION( minimize,          0,  0,  1,0,0,1, "minimize learned clauses") \
...
OPTION( reduce,            0,  0,  1,0,0,1, "reduce useless clauses") \
...
OPTION( shrink,            0,  0,  3,0,0,1, "shrink conflict clause (1=only with binary, 2=minimize when pulling, 3=full)") \
...
OPTION( walknonstable,     0,  0,  1,0,0,1, "walk in non-stabilizing phase") \
